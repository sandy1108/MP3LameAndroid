...
void Java_com_wsgh_androidutils_mp3lame_MP3LameUtils_initEncoder(JNIEnv *env,
...
void Java_com_wsgh_androidutils_mp3lame_MP3LameUtils_destroyEncoder(
		JNIEnv *env, jobject jobj) {
	int res = lame_close(lame);
	LOGD("Deinit returned: %d", res);
}

void Java_com_wsgh_androidutils_mp3lame_MP3LameUtils_encodeFile(JNIEnv *env,
